...
import { MapPin, Wifi, WifiOff, CheckCircle2, Calendar, Sparkles, AlertTriangle, Loader2, LogIn, LogOut } from "lucide-react";
    ...
    <div className="space-y-5">
      ...
      <section className="overflow-hidden rounded-3xl bg-gradient-dark p-6 text-white shadow-soft">
        ...
        <div className="mt-5 grid grid-cols-2 gap-3 text-xs">
          <StatusPill icon={MapPin} label={t("gpsStatus")}
            value={todayRow?.city || todayRow?.branch || "—"}
            state={todayRow ? "ok" : "checking"} />
          <StatusPill icon={online ? Wifi : WifiOff} label={t("networkStatus")}
