...
import { Save, RotateCcw, Plus, Trash2, Clock, Wallet, Target, AlertTriangle, Gauge, CalendarDays, Sparkles, Pencil, X, Check, Wifi, Building2, Briefcase, MapPin, Mail, Bell, Send, CalendarClock, Play, Timer, Coins, Tag, ChevronRight, Shield } from "lucide-react";
...
type Section = "shift" | "penalties" | "allowances" | "targets" | "kpis" | "holidayTypes" | "networks" | "smtp" | "notifPrefs" | "autoExports" | "security";
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Field label={t("smtpPassword")}>
                <input type="password" value={smtpDraft.password} onChange={(e) => setSmtpDraft({ ...smtpDraft, password: e.target.value })} className={inputCls} dir="ltr" />
              </Field>
            ...
            <div className="flex flex-wrap gap-2">
              <button
                onClick={() => { updateSmtp(smtpDraft); toast.success(t("settingsSaved")); }}
